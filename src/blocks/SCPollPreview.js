...
class SCPollPreview extends React.Component {
    render() {
        ...
        const text = this.props.pollIsDone ? "Посмотреть результаты" : "Начать";
        const button = (<Div><Button level="commerce" onClick={() => this.props.runTest()} size="xl">{text}</Button></Div>);
